...
namespace StorageSystem.WEB.Pages.Suppliers
{
    public partial class SuppliersIndex
    {
        ...
        private async Task<bool> LoadListAsync(int page)
        {
            ...
            var url = $"api/Suppliers/?page={page}&recordsnumber={RecordsNumber}";
        ...
        {
            ValidateRecordsNumber(RecordsNumber);
            var url = $"api/Suppliers/totalPages?recordsnumber={RecordsNumber}";
            if (!string.IsNullOrWhiteSpace(Filter))
            {
                url += $"&filter={Filter}";
            }
        ...
        private async Task DeleteAsync(Supplier supplier)
        {
            ...
            {
                Title = "Confirmacion",
                Text = $"¿Estas seguro que quieres borrar el proveedor: {supplier.Name}?",
